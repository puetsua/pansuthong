...
export const THEME_PRESETS: Preset[] = [
  {
    ...
    light: {
      ...
      "--c-danger": "#dc2626",
      "--c-heat-done": "#16a34a", "--c-heat-skip": "#cbd5e1", "--c-heat-empty": "#f9fafb", "--c-heat-border": "#e5e7eb", "--c-heat-today": "#4338ca",
    },
    dark: {
      ...
      "--c-danger": "#fca5a5",
      "--c-heat-done": "#22c55e", "--c-heat-skip": "#475569", "--c-heat-empty": "#0f172a", "--c-heat-border": "#334155", "--c-heat-today": "#818cf8",
    },
  },
  {
    id: "slate",
    ...
    light: {
      ...
      "--c-danger": "#dc2626",
      "--c-heat-done": "#16a34a", "--c-heat-skip": "#94a3b8", "--c-heat-empty": "#f1f5f9", "--c-heat-border": "#cbd5e1", "--c-heat-today": "#0369a1",
    },
    dark: {
      ...
      "--c-danger": "#fca5a5",
      "--c-heat-done": "#34d399", "--c-heat-skip": "#475569", "--c-heat-empty": "#0b1220", "--c-heat-border": "#2b3a55", "--c-heat-today": "#38bdf8",
    },
  },
  {
    id: "sepia",
    ...
    light: {
      ...
      "--c-danger": "#b4452b",
      "--c-heat-done": "#5f7d3a", "--c-heat-skip": "#c4b393", "--c-heat-empty": "#f5efe3", "--c-heat-border": "#ddcfb6", "--c-heat-today": "#9a6a2f",
    },
    dark: {
      ...
      "--c-danger": "#e08b6a",
      "--c-heat-done": "#a3c474", "--c-heat-skip": "#6b5c44", "--c-heat-empty": "#211b12", "--c-heat-border": "#4d3f2c", "--c-heat-today": "#d9a657",
    },
  },
  {
    id: "high_contrast",
    ...
    light: {
      ...
      "--c-danger": "#b00000",
      "--c-heat-done": "#000000", "--c-heat-skip": "#777777", "--c-heat-empty": "#ffffff", "--c-heat-border": "#000000", "--c-heat-today": "#0000cc",
    },
    dark: {
      ...
      "--c-danger": "#ff6666",
      "--c-heat-done": "#ffffff", "--c-heat-skip": "#999999", "--c-heat-empty": "#000000", "--c-heat-border": "#ffffff", "--c-heat-today": "#66b3ff",
    },
  },
  {
    id: "emerald",
    ...
    light: {
      ...
      "--c-danger": "#dc2626",
      "--c-heat-done": "#047857", "--c-heat-skip": "#9db3a6", "--c-heat-empty": "#f6faf7", "--c-heat-border": "#d3e3d8", "--c-heat-today": "#047857",
    },
    dark: {
      ...
      "--c-danger": "#fca5a5",
      "--c-heat-done": "#34d399", "--c-heat-skip": "#44614f", "--c-heat-empty": "#07120d", "--c-heat-border": "#244536", "--c-heat-today": "#34d399",
    },
  },
  {
    id: "rose",
    ...
    light: {
      ...
      "--c-danger": "#dc2626",
      "--c-heat-done": "#0f766e", "--c-heat-skip": "#c9a7b4", "--c-heat-empty": "#fdf6f8", "--c-heat-border": "#efd2dc", "--c-heat-today": "#be185d",
    },
    dark: {
      ...
      "--c-danger": "#fca5a5",
      "--c-heat-done": "#2dd4bf", "--c-heat-skip": "#5e4350", "--c-heat-empty": "#140a0f", "--c-heat-border": "#4a2a39", "--c-heat-today": "#f472b6",
    },
  },
];
