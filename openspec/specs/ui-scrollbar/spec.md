# ui-scrollbar Specification

## Purpose

Themed scrollbar chrome for scrollable app surfaces on desktop and Android
WebViews, driven by existing theme color tokens so track and thumb match the
active light, dark, or custom preset.
...
The system SHALL NOT introduce a Settings control or persisted preference for scrollbar appearance; themed scrollbars are always applied with the active theme.

#### Scenario: Settings has no scrollbar toggle
- **WHEN** the user opens Settings
- **THEN** there is no control to enable, disable, or recolor the custom scrollbar
